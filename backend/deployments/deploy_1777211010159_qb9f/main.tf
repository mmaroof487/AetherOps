...
# Generated: 2026-04-26T13:43:30.212Z
...
variable "app_name"    { default = "store" }
...
resource "aws_iam_instance_profile" "ec2" { name = "${var.app_name}-ec2-profile"; role = aws_iam_role.ec2.name }
...
output "app_instance_ip"  { value = aws_instance.app.public_ip }
output "rds_endpoint"     { value = aws_db_instance.main.endpoint }
output "rds_username"     { value = aws_db_instance.main.username }
output "rds_password"     { value = random_password.db.result; sensitive = true }
